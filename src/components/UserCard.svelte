...
<div class={`flex flex-col xl:h-96 md:h-80 h-64 rounded-lg shadow-lg scale-100 hover:scale-105 hover:transition-all transition-all duration-500 hover:duration-200 ${$$props.class} overflow-hidden relative select-none`}>
